            ...
            <div class="col-lg-6 p-0">
                <div class="d-flex flex-column flex-lg-row w-100 tlb">
                    <p class="p-4" style="color: aliceblue">
                        La convocatoria abierta del Premio Ideas en Acción invita a presentar innovaciones implementadas por empresas prestadoras de servicio de agua y/o saneamiento en América Latina y el Caribe. 
                        <br>Este año, la convocatoria también invita a las empresas a presentar desafíos o problemáticas que puedan ser atendidas a través de soluciones innovadoras en desalinización, tratamiento y reúso, SWIT y/o gestión.
                        <br>En el 2020 el Premio Ideas en Acción consta de dos categorías.
                    </p>
                </div>
                <div>
